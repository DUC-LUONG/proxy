...
if __name__ == '__main__':
    ...
    #List keyword
    urls = (
            'https://play.google.com/store/search?q=rdp&c=apps', 
            'https://play.google.com/store/search?q=remote%20desktop%20protocol&c=apps', 
            'https://play.google.com/store/search?q=control%20android&c=apps'
            )
            ...
            while True:
                ...
                for href in hrefs:
                    ...
                    if hostname == HOSTNAME_BASE and link not in url_list:
                        ...
                        process_list.append([link, description.get_attribute('title')])
